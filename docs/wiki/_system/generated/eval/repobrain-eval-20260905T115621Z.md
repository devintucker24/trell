# RepoBrain baseline evaluation — 2026-09-05 11:56:21 UTC

**Overall:** PASS

Commit: `9a1545333542ed804d78424d46640e30ec8a9c25`
...
| `context-budgets` | yes | PASS | Tier-0 1703/2000; max retrieved 1248/3500; combined 2951/9500 estimated tokens. |
...
[
  {
    "id": "maritime-safety",
    "passed": true,
    "command": "python3 docs/wiki/_system/scripts/wiki_retrieve.py \"How does Trell keep autonomous ships safe under COLREGs?\" --k 8 --budget-tokens 3500 --lane all --json --no-log",
    "top_k": 8,
    "packed_tokens": 1248,
    "budget_tokens": 3500,
    "source_checks": [
    ...
    "ranked_paths": [
      ...
      {
        "rank": 7,
        "path": "market/regulatory-and-insurance-drivers.md",
        "score": 0.5292,
        "provenance": "compiled"
      },
      {
  ...
  },
  {
    "id": "belief-certain",
    "passed": true,
    "command": "python3 docs/wiki/_system/scripts/wiki_retrieve.py \"What is belief vs certain and how does verify work?\" --k 8 --budget-tokens 3500 --lane all --json --no-log",
    "top_k": 8,
    "packed_tokens": 1182,
    "budget_tokens": 3500,
    "source_checks": [
  ...
  },
  {
    "id": "natural-syntax",
    "passed": true,
    "command": "python3 docs/wiki/_system/scripts/wiki_retrieve.py \"Natural Trell colon indent end syntax\" --k 8 --budget-tokens 3500 --lane all --json --no-log",
    "top_k": 8,
    "packed_tokens": 1174,
    "budget_tokens": 3500,
    "source_checks": [
  ...
  },
  {
    "id": "competitors",
    "passed": true,
    "command": "python3 docs/wiki/_system/scripts/wiki_retrieve.py \"Why not LangChain or BAML for epistemic safety?\" --k 8 --budget-tokens 3500 --lane all --json --no-log",
    "top_k": 8,
    "packed_tokens": 1197,
    "budget_tokens": 3500,
    "source_checks": [
  ...
  },
  {
    "id": "ten-year",
    "passed": true,
    "command": "python3 docs/wiki/_system/scripts/wiki_retrieve.py \"What is the ten year vision for Trell?\" --k 8 --budget-tokens 3500 --lane all --json --no-log",
    "top_k": 8,
    "packed_tokens": 1033,
    "budget_tokens": 3500,
    "source_checks": [
  ...
  },
  {
    ...
    "passed": true,
    "command": "python3 docs/wiki/_system/scripts/wiki_retrieve.py \"What did we decide about wiki memory and RAG?\" --k 8 --budget-tokens 3500 --lane episodic --json --no-log",
    "top_k": 8,
    "packed_tokens": 623,
    "budget_tokens": 3500,
    "source_checks": [
  ...
  },
  {
    ...
    "passed": true,
    "command": "python3 docs/wiki/_system/scripts/wiki_retrieve.py \"What changed in the wiki brain timeline?\" --k 8 --budget-tokens 3500 --lane temporal --json --no-log",
    "top_k": 8,
    "packed_tokens": 453,
    "budget_tokens": 3500,
    "source_checks": [
  ...
  },
  {
    ...
    "context_manifest": [
      ...
      },
      {
        "kind": "retrieved-excerpt",
        "path": "applications/autonomous-physical-systems.md",
        "anchor": "1-autonomous-cargo-container-ships-maritime-collision-avoida",
        "characters": 500
      },
      {
        "kind": "retrieved-excerpt",
      ...
      },
      {
        "kind": "retrieved-excerpt",
        "path": "market/regulatory-and-insurance-drivers.md",
        "anchor": "b-international-maritime-organization-imo-mass-code",
        "characters": 329
      },
      {
        "kind": "retrieved-excerpt",
...
[
  {
    ...
    "status_exit_code": 0,
    "status": "graphify CLI: /home/ubuntu/.local/bin/graphify\nenabled: True\ncode_only: True\ntargets: ['src']\ngraph.json: ./graphify-out/graph.json OK\nnodes: 151\nedges: 486 {'EXTRACTED': 481, 'INFERRED': 5}\nrelations: [('references', 204), ('calls', 166), ('method', 61), ('contains', 38), ('imports_from', 14), ('implements', 3)]\ngod nodes:\n  Parser (27 edges) \u2190 parser.rs\n  Expr (24 edges) \u2190 ast.rs\n  .advance() (20 edges) \u2190 parser.rs\n  ast.rs (19 edges) \u2190 ast.rs\n  Result (19 edges) \u2190 \n  TypeChecker (18 edges) \u2190 typecheck.rs\n  RuntimeValue (17 edges) \u2190 interpreter.rs\n  .new() (16 edges) \u2190 parser.rs",
    "query_command": "python3 docs/wiki/_system/scripts/wiki_graphify.py query Parser --budget 800",
    "query_exit_code": 0,
    ...
    "freshness": {
      ...
      "current_commit": "9a1545333542ed804d78424d46640e30ec8a9c25",
      "changed_targets": []
    },
    "failures": []
  }
...
Tier-0 1703/2000; max retrieved 1248/3500; combined 2951/9500 estimated tokens.
...
[
  {
    ...
    "baseline_observation": "Current setup detection reports only its existing narrow raw-source set; later source-inventory tickets must add ADR/docs-site discovery.",
    "failures": []
  }
]
```
