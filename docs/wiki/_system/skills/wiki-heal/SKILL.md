...
|------:|---------------|-----|
| 1 | invalid / missing frontmatter | `_system/skills/wiki-label` + SCHEMA required fields |
...
| 8 | `graphify_graph_missing` | `python3 docs/wiki/_system/scripts/wiki_graphify.py sync` |
