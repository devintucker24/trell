...
Usage:
  python3 docs/wiki/scripts/wiki_usage.py log --op retrieve --query "..." --tokens-est 1200 --hits 8
  python3 docs/wiki/scripts/wiki_usage.py report --days 30
  python3 docs/wiki/scripts/wiki_usage.py score --days 30
"""
...
from wiki_paths import DASHBOARD_PATH, EVENTS_PATH, USAGE_DIR
...
Generated `{today}` from local `docs/wiki/_meta/usage/events.jsonl` (last **{days}** days).
