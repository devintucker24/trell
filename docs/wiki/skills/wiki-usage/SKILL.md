...
## What is tracked
Catalog: `docs/wiki/_meta/usage-telemetry.md`  
Dashboard: `docs/wiki/_meta/usage-dashboard.md` (generated, committed)  
Raw events: `docs/wiki/_meta/usage/events.jsonl` (**gitignored**)
...
python3 docs/wiki/scripts/wiki_usage.py log --op query \
  --query "<question>" \
...
python3 docs/wiki/scripts/wiki_usage.py log --op dump --query "<why>"
