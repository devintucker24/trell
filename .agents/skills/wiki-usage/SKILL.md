---
name: wiki-usage
description: Deprecated compatibility alias; canonical playbook: docs/wiki/_system/skills/wiki-usage/SKILL.md
---
...
```text
docs/wiki/_system/skills/wiki-usage/SKILL.md
```
