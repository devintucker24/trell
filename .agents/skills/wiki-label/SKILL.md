---
name: wiki-label
description: Deprecated compatibility alias; canonical playbook: docs/wiki/_system/skills/wiki-label/SKILL.md
---
...
```text
docs/wiki/_system/skills/wiki-label/SKILL.md
```
