---
name: wiki-retrieve
description: Hybrid file-RAG retrieve over the Trell wiki — lexical + graph proximity + temporal validity/rerank with MMR diversity. Use instead of dumping INDEX; prefer before query answers.
---
